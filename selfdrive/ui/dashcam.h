...
static void ui_draw_debug1(UIState *s) 
{
  ...
  nvgTextAlign(s->vg, NVG_ALIGN_LEFT | NVG_ALIGN_BASELINE);
  ui_draw_text(s, 0, 1035, scene.alertTextMsg1.c_str(), 40, COLOR_WHITE_ALPHA(125), "sans-semibold");
  ui_draw_text(s, 0, 1078, scene.alertTextMsg2.c_str(), 40, COLOR_WHITE_ALPHA(125), "sans-semibold");
}
